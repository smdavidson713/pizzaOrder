...
{ 
   public static void main (String[] args)
   {
      ...
      if(inches == 10){
         ...
         cost = 12.99;
         System.out.println("You did not put in one of the choices. A 12 inch pizza will be made.");
      }
      ...
      switch(crustType){
         ...
         break;
         default:
            System.out.println("You did not put in one of the choices. A hand-tossed pizza will be made.");
 }
